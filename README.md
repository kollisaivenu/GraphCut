# GraphCut Graph Partitioner
 ...
 GraphCut is a multilevel k-way graph partitioner built in Rust. It takes in as input a graph (denoted by a sparse matrix) in matrix market format and partitions it into k partitions with the goal of minimizing edge cut and balancing the weights of the k partitions.
